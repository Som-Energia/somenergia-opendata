define({ "api": [
  {
    "type": "get",
    "url": "/v2.0/:field[/by/:geolevel]/on/:ondate|/frequency/:frequency[/from/:fromdate][/to/:todate]?queryFilter=:locationFilters",
    "title": "",
    "version": "0.2.0",
    "name": "Distribution",
    "group": "Distribution",
    ...
    "sampleRequest": [
      {
        "url": "https://opendata.somenergia.coopv0.2/contracts/by/ccaas/yearly/from/2010-01-01/to/2013-01-01?country=ES"
      }
    ],
    "success": {
      "examples": [

define({ "api": [
  {
    ...
    "group": "Distribution",
    "name": "Distribution",
    "description": "<p>Returns the geographical distribution of a quantity at a given date.</p> <p>Use the geolevel to get more geographical detail (countries, ccaas, states, cities).</p> <p>Use the filters in the query string to restrict to a group of geographical entities. The filters are additive. That means that any city matching any of the specified values will be counted.</p>",
    "examples": [
      {
  ...
  },
  {
    ...
    "description": "<p>Returns the geographical distribution and temporal evolution of a quantity.</p> <p>Use the geolevel to get more geographical detail (countries, ccaas, states, cities).</p> <p>Use the filters in the query string to restrict to a group of geographical entities. The filters are additive. That means that any city matching any of the specified values will be counted.</p>",
    "examples": [
      {

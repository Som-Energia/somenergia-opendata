define({ "api": [
  ...
  },
  {
    ...
    "group": "Map",
    "name": "Map",
    "description": "<p>Returns a map that represents the geographical distribution at a given date.</p> <p>Use the geolevel choose the map detail (ccaa, state). Use the filters in the query string to choose the language. If no language is specified, the language is chosen using the request headers.</p>",
    "examples": [
      {
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "Response",
            "description": "<p>Map animation that represents the temporal evolution of the geographical distribution</p>"
          }
        ]
      }
    },
    "filename": "som_opendata/api.py",
    "groupTitle": "MapSeries",
    "sampleRequest": [
      {

...
FROM (
	...
	values
		...
		('17148','2012-01-01'::date,'Riudarenes_BR','501215456', 20),
		('17148','2012-01-01'::date,'Riudarenes_ZE','501215457', 18),
		('25228','2013-01-01'::date,'Torrefarrera','28302095', 90),
		('08112','2013-01-01'::date,'Manlleu_Piscina','28301116', 90),
		('08112','2013-01-01'::date,'Manlleu_Pavello','28301134', 100),
		('46193','2013-01-01'::date,'Picanya','70312', 290),
		('25230','2013-01-01'::date,'Torregrossa','28301107', 500),
		('47114','2015-01-01'::date,'Valteina','80429506', 1000),
		('41006','2016-01-01'::date,'Alcolea','501600324', 2160),
		('41055','2018-01-01'::date,'Matallana','502016144', 2000),

...
WHERE
	-- ABCDEFGHJPQRSUVNW
	partner.vat like 'ESA%%' OR
	partner.vat like 'ESB%%' OR
	partner.vat like 'ESC%%' OR
	partner.vat like 'ESD%%' OR
	partner.vat like 'ESE%%' OR
	partner.vat like 'ESF%%' OR
	partner.vat like 'ESG%%' OR
	partner.vat like 'ESH%%' OR
	partner.vat like 'ESJ%%' OR
	partner.vat like 'ESP%%' OR
	partner.vat like 'ESQ%%' OR
	partner.vat like 'ESR%%' OR
	partner.vat like 'ESS%%' OR
	partner.vat like 'ESU%%' OR
	partner.vat like 'ESV%%' OR
	partner.vat like 'ESN%%' OR
	partner.vat like 'ESW%%' OR
FALSE
ORDER BY partner.id

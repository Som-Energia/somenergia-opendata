...
class IntelligentSource_test(unittest.TestCase):
    ...
    def test__get__firstPartialResponse(self):
        source = self.createSource(
            ns(members=[
                headers,
                data_SantJoan
        ...
        result = source.get('members', ['2018-01-01', '2019-01-01'], ns())
        self.assertNsEqual(ns(data=result), """\
            data:
            - codi_pais: ES
              pais: 'España'
    ...
    def test__get__secondPartialResponse(self):
        source = self.createSource(
            ns(members=[
                headers,
                data_SantJoan
        ...
        result = source.get('members', ['2018-02-01', '2018-03-01'], ns())
        self.assertNsEqual(ns(data=result), """\
            data:
            - codi_pais: ES
              pais: 'España'
